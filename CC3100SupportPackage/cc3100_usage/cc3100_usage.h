 ...
 * Should be in long format, E.g: 0xc0a8010a == 192.168.1.99
 */
#define HOST_IP_ADDR           0x0a23200c           	// IP address of server to connect to 0x63 = 99
 ...
 */
#define CONFIG_IP       SL_IPV4_VAL(10,35,32,12)			/* Static IP to be configured */
#define AP_MASK         SL_IPV4_VAL(255,255,255,0)      /* Subnet Mask for the station */
#define AP_GATEWAY      SL_IPV4_VAL(10,35,32,1)          /* Default Gateway address */
#define AP_DNS          SL_IPV4_VAL(10,35,32,1)            /* DNS Server Address */
